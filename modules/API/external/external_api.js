...
export default class JitsiMeetExternalAPI extends EventEmitter {
    /**
     * Constructs new API instance. Creates iframe and loads Hoc Lien Tuc in it.
     *
    ...
    /**
     * Getter for the large video element in Hoc Lien Tuc.
     *
    ...
    /**
     * Getter for the prejoin video element in Hoc Lien Tuc.
     *
    ...
    /**
     * Getter for participant specific video element in Hoc Lien Tuc.
     *
     ...
     * {@code readyToClose} - all hangup operations are completed and Hoc Lien Tuc
    ...
    /**
     * Removes the listeners and removes the Hoc Lien Tuc frame.
     *
     * @returns {void}
     */
    dispose() {
    ...
    /**
     * Returns the iframe that loads Hoc Lien Tuc.
     *
