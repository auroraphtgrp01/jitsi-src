 ...
 * JitsiMeetJS#init(). The app will download config.js from the Hoc Lien Tuc
 ...
 * The app will download config.js from the Hoc Lien Tuc deployment and take its
 ...
 * config.js from the Hoc Lien Tuc deployment and take its values into account but
...
function _setConfig(state: IConfig, { config }: { config: IConfig }) {
    ...
    const newState = merge(
        ...
        // downloaded from the Hoc Lien Tuc deployment because the former contains
