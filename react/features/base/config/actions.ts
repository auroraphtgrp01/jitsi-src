...
/**
 * Signals that the configuration (commonly known in Hoc Lien Tuc as config.js)
...
/**
 * Signals that a configuration (commonly known in Hoc Lien Tuc as config.js)
...
/**
 * Stores a specific Hoc Lien Tuc config.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The Hoc Lien Tuc config.js to store.
 * @returns {Function}
 */
