...
class Watermarks extends Component<IProps, State> {
    ...
    _renderJitsiWatermark() {
        const { _logoLink, _showJitsiWatermark } = this.props;
        ...
        const duyTanLogoUrl = "images/logo_Hoc Lien Tuc.png";

        if (_showJitsiWatermark) {
            const style = {
                backgroundImage: `url(${duyTanLogoUrl})`,
            ...
            if (_logoLink) {
                reactElement = (
                    <a
                        aria-label={t("jitsiHome", { logo: "Học liên tục" })}
                        className={className}
                        href="/"
                        target="_self"
                    >
