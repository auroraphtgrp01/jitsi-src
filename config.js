...
var config = {
    ...
    // Moves all Duy Tan University 'beforeunload' logic (cleanup, leaving, disconnecting, etc) to the 'unload' event.
    ...
    */
     ...
     * which is retrieved internally by Duy Tan University) (e.g. https://meet.jit.si/someMeeting
